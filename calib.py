...
if __name__ == '__main__':
    ...
    R_W0, T_W0 = get_world_space_origin(cmtx0, dist0, os.path.join('frames_pair', 'camera0_5.png'))
    #get rotation and translation from world directly to camera1
    R_W1, T_W1 = get_cam1_to_world_transforms(cmtx0, dist0, R_W0, T_W0,
                                              cmtx1, dist1, R1, T1,
                                              os.path.join('frames_pair', 'camera0_5.png'),
                                              os.path.join('frames_pair', 'camera1_5.png'),)
